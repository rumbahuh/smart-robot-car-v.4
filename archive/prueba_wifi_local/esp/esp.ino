...
#define EAP_IDENTITY "r.castilla.2023@alumnos.urjc.es"
#define EAP_PASSWORD "#FUCKyou24"
#define EAP_USERNAME "r.castilla.2023@alumnos.urjc.es"

// WiFi configuration
const char* wifi_ssid = "eduroam";
//const char* wifi_password = "#FUCKyou24";
